...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.setFilter":
		...
		return e.complexity.Mutation.SetFilter(childComplexity, args["filter"].(*Filter)), true
...
var sources = []*ast.Source{
	{Name: "../graphql/schema.graphql", Input: `interface Node {
  id: ID!
}
...
func (ec *executionContext) field_Mutation_setFilter_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["filter"]; ok {
		...
		arg0, err = ec.unmarshalOFilter2ᚖtodoᚐFilter(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_setFilter(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().SetFilter(rctx, args["filter"].(*Filter))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(Filter)
	fc.Result = res
	return ec.marshalNFilter2todoᚐFilter(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNFilter2todoᚐFilter(ctx context.Context, v interface{}) (Filter, error) {
	var res Filter
...
func (ec *executionContext) unmarshalOFilter2ᚖtodoᚐFilter(ctx context.Context, v interface{}) (*Filter, error) {
	if v == nil {
		return nil, nil
	}
	var res = new(Filter)
...
func (ec *executionContext) marshalOFilter2ᚖtodoᚐFilter(ctx context.Context, sel ast.SelectionSet, v *Filter) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
