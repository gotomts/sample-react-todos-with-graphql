...
func (m *TodoMutation) ClearText() {
	m.text = nil
	m.clearedFields[todo.FieldText] = struct{}{}
}

// TextCleared returns if the "text" field was cleared in this mutation.
func (m *TodoMutation) TextCleared() bool {
	_, ok := m.clearedFields[todo.FieldText]
	return ok
}
...
func (m *TodoMutation) ResetText() {
	m.text = nil
	delete(m.clearedFields, todo.FieldText)
}
...
func (m *TodoMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(todo.FieldText) {
		fields = append(fields, todo.FieldText)
	}
	return fields
}
